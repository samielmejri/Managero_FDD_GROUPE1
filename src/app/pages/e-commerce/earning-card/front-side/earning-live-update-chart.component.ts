...
export class EarningLiveUpdateChartComponent implements AfterViewInit, OnDestroy, OnChanges {
  ...
  ngOnChanges(): void {
    if (this.option) {
      this.updatEChartsOptions(this.liveUpdateChartData);
    }
  }
      ...
      series: [
        {
          ...
          areaStyle: {
            normal: {
              color: new EChartsOption.graphic.LinearGradient(0, 0, 0, 1, [{
                offset: 0,
  ...
  updatEChartsOptions(chartData: { value: [string, number] }[]) {
